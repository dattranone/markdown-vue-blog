<template>
  <div class="privacy">
    ...
    <p>This privacy policy applies to the Cute Bunny app (hereby referred to as "Application") for mobile devices that was
      created by Dat Tran (hereby referred to as "Service Provider") as a Commercial service. This service is intended for
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
      ...
      contact them at tranthanhdat.it@gmail.com and they will respond in a reasonable time.</p>
    ...
    <div><br>
      <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect
        ...
        information, please contact the Service Provider (tranthanhdat.it@gmail.com) so that they will be able to take the
        necessary actions.</p>
    ...
    <p>This privacy policy is effective as of 2024-05-11</p><br><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
      please contact the Service Provider via email at tranthanhdat.it@gmail.com.</p>
    <hr>
...
<script>
export default {
  name: 'CuteBunnyPrivacy',
  mounted() {
    useHead({
      title: 'Cute Bunny Watch Face Policy'
    })
  },
}
</script>
